...
let g:colors_name="sosoeike"

" hi Normal       guifg=black   guibg=#e4e4e4          ctermfg=black    ctermbg=white
hi Normal       guifg=black   guibg=#FFF9B7          ctermfg=black
...
hi StatusLine   guifg=red     guibg=black   gui=bold ctermfg=red      ctermbg=black cterm=bold
hi StatusLineNC guifg=green   guibg=grey40  gui=NONE ctermfg=green    ctermbg=black cterm=NONE
...
if version >= 700
  ...
  " Spell
  hi SpellBad   guifg=#cc0000 gui=undercurl guisp=#cc0000 ctermbg=magenta cterm=underline
  hi SpellRare  guifg=magenta gui=undercurl               ctermbg=red     cterm=underline
