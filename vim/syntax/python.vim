...
" EIKE: Highlight formats in strings (see line +305)
...
" This must be called before :let b:current_syntax = "python"
syn include @CPP syntax/cpp.vim
" syn region cppString matchgroup=pythonString start=+\z("""\|'''\) *// *[cC]+ end=+\z1+ keepend containedin=ALL contains=@CPP
